...
local filter = {
    ...
    ["dremora_ttpc"] = true, -- TODO Krazzt talks name?
    ["dremora_special_Fyr"] = false,
    ["golden saint_staada"] = false,
    ["lustidrike"] = true, -- TODO Lustidrike talks name?
    ...
    ["ancestor_ghost_vabdas"] = true, -- TODO Mansilamat Vabdas talks name?
    ...
    ["draugr_aesliip"] = true, -- TODO Draugr Lord Aesliip talks name?
